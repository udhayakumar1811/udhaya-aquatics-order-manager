...
export default function ReportsAnalytics() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 bg-gray-50/50 min-h-screen text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4">
              ...
              <div className="flex justify-center items-center gap-4 text-xs text-gray-600 flex-wrap">
                <span className="flex items-center gap-1.5"><span className="w-3 h-3 bg-amber-400 rounded-sm inline-block"></span> Pending</span>
                <span className="flex items-center gap-1.5"><span className="w-3 h-3 bg-blue-500 rounded-sm inline-block"></span> Packed</span>
                <span className="flex items-center gap-1.5"><span className="w-3 h-3 bg-purple-500 rounded-sm inline-block"></span> Shipped</span>
                <span className="flex items-center gap-1.5"><span className="w-3 h-3 bg-emerald-500 rounded-sm inline-block"></span> Delivered</span>
              </div>

              <div className="flex justify-center py-4">
                <div className="w-48 h-48 rounded-full border-[18px] border-amber-400 flex items-center justify-center bg-white shadow-inner relative">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4">
              ...
              <div className="flex justify-center items-center gap-6 text-xs text-gray-600">
                <span className="flex items-center gap-1.5"><span className="w-3 h-3 bg-cyan-400 rounded-sm inline-block"></span> Thermocol Box 🧊</span>
                <span className="flex items-center gap-1.5"><span className="w-3 h-3 bg-amber-400 rounded-sm inline-block"></span> Cardboard Box 📦</span>
              </div>
